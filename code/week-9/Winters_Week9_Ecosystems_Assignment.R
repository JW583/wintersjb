...
# (Q1 - 12 pts) Use the dataset from the tutorial to complete one redundancy analysis (RDA) with variance partitioning on a different community (NOT the nematodes).
  ...
  #Why did you reduce these to 6 rows each? That removed a lot of useful data.
  ...
  anova(ord)  
  plot(ord)
  #Removing all of those rows of data explains why these results look strange.
  ...
  #None of these are linear models as stated in the directions. They are all rda() instead of lm()

  # (Q3 - 6 pts) Provide a 3-4 sentence synthesis of how these results relate to one another and the value of considering both together for interpreting biotic-abiotic interactions.
  
  #Based on my results, both magnesium and phosphorous are highly important abiotic factors when determining the various plant species that can thrive in these communities. 
  #Both magnesium and phosphorous concentrations affect the soil chemestry within these locations, which these nutrients the plants would be able to take in and use to grow and multiply, in this case plant diversity seemed to be most abundant in places with higher concentration of these two elements, versus plots where these elements were lacking having an overall lower diversity and abundance. 
  #Tying this into a bigger picture, these plants most likely correlate to more oxygen and nitrogen within the community, allowing the invertebrates and nematodes to benefit from the fix and be more diverse in the location with more fauna diversity, creating a stronger and more stable community than to places that were lacking in these resources that hindered these plants species overall success.
